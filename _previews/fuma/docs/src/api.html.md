...
### yardang.build.generate_docs_configuration(, project: str | None = None, title: str | None = None, module: str | None = None, description: str | None = None, author: str | None = None, copyright: str | None = None, version: str | None = None, theme: str | None = None, docs_root: str | None = None, root: str | None = None, source_dir: str | None = None, cname: str | None = None, pages: list | None = None, use_autoapi: bool | None = None, autoapi_ignore: list | None = None, custom_css: Path | None = None, custom_js: Path | None = None, html_output_dir: str | None = None, config_base: str | None = None, previous_versions: bool | None = False, adjust_arguments: Callable | None = None, adjust_template: Callable | None = None)[[source]](../../_modules/yardang/build.html.md#generate_docs_configuration)
...
* **Parameters:**
  ...
  - **source_dir** – Existing Sphinx source directory. When set, root names an existing document relative to this directory and no index is generated.
...
### yardang.build.run_doxygen_if_needed(breathe_projects: dict[str, str], , force: bool = False, quiet: bool = False) → dict[str, bool][[source]](../../_modules/yardang/build.html.md#run_doxygen_if_needed)
...
<a id="yardang.build.theme_module"></a>

### yardang.build.theme_module(theme: str) → str[[source]](../../_modules/yardang/build.html.md#theme_module)
...
### yardang.cli.build(, quiet: bool = False, debug: bool = False, pdb: bool = False, warning_is_error: bool = False, project: str | None = None, title: str | None = None, module: str | None = None, description: str | None = None, author: str | None = None, copyright: str | None = None, version: str | None = None, theme: str | None = None, docs_root: str | None = None, root: str | None = None, source_dir: str | None = None, cname: str | None = None, pages: list[Path] | None = None, use_autoapi: bool | None = None, custom_css: Path | None = None, custom_js: Path | None = None, output: str = 'docs/html', config_base: str | None = 'tool.yardang', previous_versions: bool | None = False)[[source]](../../_modules/yardang/cli.html.md#build)

<a id="yardang.cli.debug"></a>

### yardang.cli.debug()[[source]](../../_modules/yardang/cli.html.md#debug)

<a id="yardang.cli.main"></a>

### yardang.cli.main()[[source]](../../_modules/yardang/cli.html.md#main)

<a id="yardang.cli.preview"></a>

### yardang.cli.preview(, themes: list[str] | None = None, output: str = 'docs/html/_previews', quiet: bool = False, debug: bool = False, pdb: bool = False)[[source]](../../_modules/yardang/cli.html.md#preview)
...
<a id="yardang.utils.HtmlTitle"></a>

### *class* yardang.utils.HtmlTitle[[source]](../../_modules/yardang/utils.html.md#HtmlTitle)

Bases: `str`

A title carrying markup that degrades to plain text for the `<title>` tag.

Themes render `docstitle` into the header verbatim but escape it for the browser tab; `__html__` is what the `|e` and `|striptags` filters pick up.

<a id="yardang.utils.get_config"></a>

### yardang.utils.get_config(section='', base='tool.yardang')[[source]](../../_modules/yardang/utils.html.md#get_config)

<a id="yardang.utils.get_config_flex"></a>

### yardang.utils.get_config_flex(section='', base='tool.yardang')[[source]](../../_modules/yardang/utils.html.md#get_config_flex)
...
The [Calculator](../../examples/cpp/docs/api.html.md#calculatorclasscalc_1_1_calculator) class provides methods for addition, subtraction, multiplication, and division. It also maintains a history of operations performed.

 Example usage: 
```default
[calc::Calculator](../../examples/cpp/docs/api.html.md#calculatorclasscalc_1_1_calculator) [calc](#calculatornamespacecalc);
double result = [calc](#calculatornamespacecalc).add(5.0, 3.0);
...
Subclassed by [calc::ScientificCalculator](../../examples/cpp/docs/api.html.md#calculatorclasscalc_1_1_scientific_calculator)
...
#### SEE ALSO
[subtract()](../../examples/cpp/docs/api.html.md#calculatorclasscalc_1_1_calculator_1a8a1a4353a488ca5a8e26e967df402b6c)
...
#### SEE ALSO
[add()](../../examples/cpp/docs/api.html.md#calculatorclasscalc_1_1_calculator_1a02adca23edb571d1230a5b053a626c9a)
...
#### SEE ALSO
[divide()](../../examples/cpp/docs/api.html.md#calculatorclasscalc_1_1_calculator_1af2da2c13c4da6cffa5b1752ab581e606)
...
#### SEE ALSO
[multiply()](../../examples/cpp/docs/api.html.md#calculatorclasscalc_1_1_calculator_1a530db79a3c237b4ef5721b601e8e5ae4)
...
This class inherits from [Calculator](../../examples/cpp/docs/api.html.md#calculatorclasscalc_1_1_calculator) and adds advanced mathematical operations like power and square root. 
...
Unlike the C++ and JavaScript examples below, the Rust pages are not written by hand. `sphinx-rustdocgen` reads each crate listed under `[tool.yardang.sphinx-rust]` and writes a page per module into the configured `doc-dir`, so the only thing to author is a toctree pointing at the result:
