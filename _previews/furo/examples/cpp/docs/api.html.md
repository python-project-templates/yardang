...
The [Calculator](#calculatorclasscalc_1_1_calculator) class provides methods for addition, subtraction, multiplication, and division. It also maintains a history of operations performed.
 ...
 Example usage: 
```default
[calc::Calculator](#calculatorclasscalc_1_1_calculator) [calc](../../../docs/src/api.html.md#calculatornamespacecalc);
double result = [calc](../../../docs/src/api.html.md#calculatornamespacecalc).add(5.0, 3.0);
