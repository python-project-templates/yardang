...
- [Furo Theme](https://github.com/pradyunsg/furo) (the default), plus bundled defaults for [`sphinx-fuma`](https://github.com/python-project-templates/sphinx-fuma), [`sphinxawesome_theme`](https://sphinxawesome.xyz/) and [`shibuya`](https://shibuya.lepture.com/)
