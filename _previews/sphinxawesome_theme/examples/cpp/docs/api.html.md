...
The [Calculator](#calculatorclasscalc_1_1_calculator) class provides methods for addition, subtraction, multiplication, and division. It also maintains a history of operations performed.
 ...
 Example usage: 
```default
[calc::Calculator](#calculatorclasscalc_1_1_calculator) [calc](../../../docs/src/api.html.md#calculatornamespacecalc); double result = [calc](../../../docs/src/api.html.md#calculatornamespacecalc).add(5.0, 3.0); std::cout << "Result: " << result << std::endl;
```
...
### [std](../../../docs/src/api.html.md#_CPPv4St)::vector<[OperationResult](../../../docs/src/api.html.md#_CPPv4N4calc15OperationResultE)> getHistory() const
...
### void recordOperation(const [OperationResult](../../../docs/src/api.html.md#_CPPv4N4calc15OperationResultE) &result)
...
### class ScientificCalculator : public [calc](../../../docs/src/api.html.md#_CPPv44calc)::[Calculator](../../../docs/src/api.html.md#_CPPv4N4calc10CalculatorE)
...
### enum class [calc](../../../docs/src/api.html.md#_CPPv44calc)::Operation
...
### [Operation](../../../docs/src/api.html.md#_CPPv4N4calc9OperationE) operation
...
### [std](../../../docs/src/api.html.md#_CPPv4St)::string description
...
### [std](../../../docs/src/api.html.md#_CPPv4St)::string [calc](../../../docs/src/api.html.md#_CPPv44calc)::formatNumber(double value, int precision = 2)
...
### typedef [std](../../../docs/src/api.html.md#_CPPv4St)::vector<[OperationResult](../../../docs/src/api.html.md#_CPPv4N4calc15OperationResultE)> [calc](../../../docs/src/api.html.md#_CPPv44calc)::HistoryList
