...
- [Furo Theme](https://github.com/pradyunsg/furo) (the default), plus bundled defaults for [`sphinx-fuma`](https://github.com/python-project-templates/sphinx-fuma), [`sphinxawesome_theme`](https://sphinxawesome.xyz/), [`shibuya`](https://shibuya.lepture.com/), and [`klink`](https://github.com/pmorissette/klink).

`yardang preview` builds the docs once per theme so you can compare them side-by-side. See [Previewing themes](configuration.html.md#previewing-themes) for the live previews.
